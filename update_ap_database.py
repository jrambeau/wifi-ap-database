...
def run_command(command, error_message):
    ...
    try:
        ...
        print_color(f"❌ {error_message}", Fore.RED)
        print_color(f"Error details: {e.stderr}", Fore.RED)
        return False
...
def update_database():
    ...
    if check_git_changes():
        ...
        print_color("\nℹ️  No changes detected in the database.", Fore.YELLOW)
...
def main():
    ...
    try:
        ...
        print_color("\n\n⚠️  Update process interrupted by user.", Fore.YELLOW)
        sys.exit(1)
